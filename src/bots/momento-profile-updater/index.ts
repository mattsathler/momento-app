...
import { initQueueProcessor, processRequest } from "./src/queues/profileQueue";
...
async function main(): Promise<void> {
    ...
    try {
        ...
        client.on("messageCreate", (message: Message) => onMessageCreate(client, message, mongoservice));
